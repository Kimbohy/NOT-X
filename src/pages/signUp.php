...
<body>
    <div class="flex flex-col items-center w-screen h-screen py-20 gap-14 md:justify-between md:flex-row md:px-10 bg-gris lg:px-60">
        ...
        <form action="../actions/session/creatAcount.php" method="post" class="flex flex-col gap-5 p-5 lg:gap-7 rounded-xl">
            ...
            <input type="password" name="password" placeholder="" class=" w-[90vw] md:w-[50vw] lg:w-[40vw] text-3xl h-12 lg:h-14 rounded-2xl p-4">
            <a href="./log.php"
